...
public class DistributedCacheService implements CacheServiceInterface {
	...
	private CRDTClient crdt;
	private ConcurrentHashMap<String, String> serverStatus;
...
//	}
	...
	public DistributedCacheService(String serverUrl, ConcurrentHashMap<String, String> serverStatus) {
		this.serverStatus = new ConcurrentHashMap<String, String>();
		this.cacheServerUrl = serverUrl;
	...
	public void get(long key) {
		Future<HttpResponse<JsonNode>> future = Unirest.get(this.cacheServerUrl + "/cache/{key}")
				.header("accept", "application/json").routeParam("key", Long.toString(key))
